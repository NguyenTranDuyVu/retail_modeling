...
LOCAL_FILE_PATH = cwd / "data" / "ecommerce-data" / "store_dim.csv"
STAGE_FILE_NAME = f"store_dim.csv"
STAGE_NAME = "~"
...
with DAG(
    ...
    trigger_transform_store_task = TriggerDagRunOperator(
        task_id="trigger_transform_store",
        trigger_dag_id="transform_store_data",
        wait_for_completion=False,
    )

    create_table_task >> upload_task >> copy_task >> trigger_transform_store_task
