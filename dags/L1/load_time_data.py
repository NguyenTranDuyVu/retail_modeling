...
LOCAL_FILE_PATH = cwd / "data" / "ecommerce-data" / "time_dim.csv"

STAGE_FILE_NAME = "time_dim.csv"
STAGE_NAME = "~"
...
with DAG(
    ...
    trigger_transform = TriggerDagRunOperator(
        task_id="trigger_transform_time_dag",
        trigger_dag_id="transform_time_data",
        wait_for_completion=False,
    )

    create_table_task >> upload_task >> copy_task >> trigger_transform
